...
broker_url = "https://exofop.ipac.caltech.edu/tess/download_toi.php?sort=toi&output=pipe"
...
class ExoFOPTESS(GenericBroker):
    ...
    def to_generic_alert(clazz, alert):
        ...
        return ExoFOPTESSAlert(
            ...
            url='https://exofop.ipac.caltech.edu/tess/target.php?id=%d' % alert['TIC ID'],
            id=alert['TIC ID'],
            name=str(alert['TOI']),
            ra=coords.ra.deg,
            dec=coords.dec.deg,
